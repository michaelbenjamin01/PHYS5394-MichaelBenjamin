...
% 'dataXSq': dataX.^2
% 'dataXCb': dataX.^3
% 'psdVec': PSD values at positive DFT frequencies
...
for lpruns = 1:nRuns   
    ...
    % Change signal estimation to include PSD and sampling frequency
    estSig = crcbgenqcsigPSD(inParams.dataX,1,qcCoefs,inParams.psdVec,inParams.sampFreq);
